...
const reviews = [
  { name: "Залим", date: "12 февраля", text: "Арендовал у ребят пс5, отлично провели выходные, порубились в игрушки! Хочу отметить сервис, он просто на высоте, очень круто организовано, одним словом ЧЁТКО! Обилие игр на любой вкус, новенькие приставки, джойстики не убитые, профессиональный подход! Красавчики! В будущем будем ещё обращаться 🤙" },
