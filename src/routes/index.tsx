...
const faqs = [
  ...
  { q: "Где мы находимся?", a: "Находимся в г. Нальчик на улице Осетинская 8 (торговый ряд «КОЛОНКА»)." },
  { q: "Во сколько можно забрать приставку?", a: "Работаем с 9:00 до 23:00, приезжайте в удобное для Вас время." },
          ...
          <div>
            ...
            <div className="mb-4 rounded-2xl overflow-hidden border border-border bg-background">
              <iframe
                ...
                style={{ filter: "invert(0.92) hue-rotate(180deg) saturate(0.85) brightness(0.95) contrast(1.05)" }}
              />
            </div>
