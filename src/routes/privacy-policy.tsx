  ...
  head: () => ({
    meta: [
      { title: "Политика конфиденциальности | GamePlay" },
      {
        name: "description",
        content:
          "Политика конфиденциальности и обработки персональных данных сайта GamePlay — аренда игровых приставок в Нальчике.",
      },
    ],
  }),
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        ...
        <p className="mt-6 text-muted-foreground leading-relaxed">
          Настоящая Политика конфиденциальности (далее — «Политика») действует в отношении сайта{" "}
          {SITE_URL} (далее — «Сайт») и описывает, какие данные посетителей Сайта обрабатываются, с
          какой целью и каким образом.
        </p>

        <Section title="1. Оператор">
          <p>
            Обработку данных в рамках использования Сайта осуществляет физическое лицо — владелец
            Сайта GamePlay (аренда игровых приставок в Нальчике). Связаться с оператором можно по
            телефону{" "}
        ...
        <Section title="2. Какие данные обрабатываются">
          <p>
            <strong className="text-foreground">Контактные данные при бронировании.</strong> Заявки
            на аренду оформляются по телефону, в WhatsApp или Telegram — эти обращения
            обрабатываются напрямую в соответствующем канале связи и не сохраняются в базе данных
            Сайта.
          </p>
          <p>
        ...
        <Section title="3. Файлы cookie">
          <p>
            ...
            использует cookie только для аналитики посещаемости (если вы дали на это согласие в
            баннере при первом посещении):
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              ...
              Форм для отправки персональных данных на Сайте нет: заявки принимаются по телефону и в
              мессенджерах. Поля входа в административную часть Сайта из записи исключены. Оператор
              — ООО «Яндекс».
            </li>
            <li>
              <strong className="text-foreground">Google Analytics</strong> — статистика посещений и
              источников трафика. Оператор — Google LLC; часть данных может обрабатываться на
              серверах за пределами РФ.
            </li>
          </ul>
          <p>
        ...
        <Section title="5. Передача данных третьим лицам">
          <p>
            ...
            это необходимо для функционирования подключённых сервисов аналитики (Яндекс.Метрика,
            Google Analytics) в объёме, который они собирают самостоятельно согласно своим политикам
            конфиденциальности, либо по требованию законодательства РФ.
          </p>
        </Section>

        <Section title="6. Ваши права">
          <p>
            Вы вправе запросить информацию об обрабатываемых данных, потребовать их уточнения или
            удаления, а также отозвать согласие на обработку — для этого достаточно связаться с
            оператором по контактам, указанным в разделе 1.
          </p>
        </Section>
